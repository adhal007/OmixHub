...
class BigQueryUtils:
    ...
    def upload_partitioned_clustered_table(self, table_id, df, schema, primary_site_col, tissue_type_col, primary_diagnosis_col):
        existing_identifiers = set()
        df['group_identifier'] = df.apply(lambda row: self.create_identifier(row, existing_identifiers), axis=1)
